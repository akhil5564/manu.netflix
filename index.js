...
const { createUser,addEntries,getAllUsers,saveTicketLimit,saveRateMaster,saveResult,getResult, loginUser,getNextBillNumber,  getNextBill,getEntries // ✅ Add this
...
app.get('/next-bill', getNextBill); // ✅ Add this
app.post('/addEntries', addEntries);
